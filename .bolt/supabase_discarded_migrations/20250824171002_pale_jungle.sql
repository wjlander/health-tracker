...
CREATE TYPE IF NOT EXISTS user_role AS ENUM ('patient', 'caregiver');
CREATE TYPE IF NOT EXISTS meal_category AS ENUM ('breakfast', 'lunch', 'dinner', 'snack');
CREATE TYPE IF NOT EXISTS activity_intensity AS ENUM ('low', 'moderate', 'high');
...
CREATE TYPE IF NOT EXISTS lab_test_category AS ENUM ('blood', 'hormone', 'vitamin', 'metabolic', 'thyroid', 'other');
CREATE TYPE IF NOT EXISTS lab_result_status AS ENUM ('low', 'normal', 'high', 'critical');
...
CREATE TRIGGER IF NOT EXISTS update_health_entries_updated_at
...
CREATE TRIGGER IF NOT EXISTS update_health_vitals_updated_at
...
CREATE TRIGGER IF NOT EXISTS update_food_nutrition_updated_at
