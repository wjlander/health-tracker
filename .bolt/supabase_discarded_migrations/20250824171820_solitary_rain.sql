/*
  # Fix Database Constraints and ON CONFLICT Issues

  1. Table Creation
    - Create all required tables with proper unique constraints
    - Fix ON CONFLICT specifications to match actual constraints
  ...
  3. Data Integrity
    ...
    - Fix constraint naming issues
*/

-- Create all required types with proper error handling
DO $$ BEGIN
...
-- Insert default users using proper INSERT with ON CONFLICT on name
